  ...
  const Login = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.storage
        ...
        .upload('profile-images/' + profileImage.fileName, profileImage);
      if (error) {
        throw error;
      }
      ...
      // Navigate to the next screen passing profileImageURL as a parameter
      ...
      setIsLoading(false);
      // Handle error accordingly, show an alert or perform other actions
    }
  };
